...
def build_action(base_dir, output_dir, platform, configuration, target, pch, action_pattern, action_name):
...
def build_module(base_dir, output_dir, platform, configuration, target, pch, module):
    if module.type == Module.Type.CPlusPlus:
        action_pattern = "Module.%s.*cpp" % (module.name,)
        action_name = "Module.%s.cpp" % (module.name,)
        build_action(base_dir, output_dir, platform, configuration, target, pch, action_pattern, action_name)
    else:
...
def build_import_library(base_dir, output_dir, platform, configuration, target, pch, import_library):
    build_action(base_dir, output_dir, platform, configuration, target, pch, import_library.name, import_library.name)

def build_binary(base_dir, output_dir, platform, configuration, target, pch, binary):
    build_action(base_dir, output_dir, platform, configuration, target, pch, binary.name, binary.name)
